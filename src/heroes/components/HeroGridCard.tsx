...
export const HeroGridCard = ({ hero }: Props) => {
  ...
  //en react 19 se prefiere use, y no useContext para evitar problemas de renderizado, 
  // pero en este caso se puede usar useContext sin problemas porque el componente no tiene lógica compleja ni dependencias que puedan causar re-renderizados innecesarios
